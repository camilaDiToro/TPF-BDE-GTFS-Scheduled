...
def load_segments_from_postgis(engine):
    query = """
    SELECT * FROM brooklyn.segments_9_10;
    """
    return gpd.read_postgis(query, engine, geom_col='geometry')

def visualize(segment_data, brooklyn_boundary=None, cutoff=80):
...
if __name__ == "__main__":
    ...
    transport_map.save("outputs/segments_morning.html")
    print("Mapa guardado como 'segments_morning.html'")
